...
fitted_nnet_rating <- predict(model_nnet_rating, test_rating_scaled, type = "class")
fitted_knn_rating <- knn(train = df[, -1], cl = df$rating, test = df_test[, -1])
...
cm_nnet <- confusionMatrix(fitted_nnet_rating, test_rating_scaled$rating)
...
cm_nnet <- confusionMatrix(fitted_nnet_cuisine, test_cuisine_scaled$Rcuisine)
